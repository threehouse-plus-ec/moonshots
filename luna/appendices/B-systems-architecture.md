...
**Functional Description:** Luna 25 was the first Russian lunar mission since 1976, marking the revival of the Luna programme. It was designed to land near the lunar south pole to study the polar environment and search for water ice. The spacecraft was lost on 19 August 2023 when the onboard computer failed to activate the BIUS-L accelerometer unit prior to an orbital correction manoeuvre. With zero angular velocity data from the inactive BIUS-L, the guidance system allowed the correction engine to fire for 127 seconds instead of the planned 84 seconds, resulting in impact at the inner rim of Pontecoulant G crater, approximately 400 km from the intended landing site. The BIUS-L was a domestically produced replacement for a previously imported component, substituted following post-2014 sanctions on Russia's space sector [Source: NASA, Roscosmos investigation].
